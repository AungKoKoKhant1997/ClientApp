...
public class MediafireConnect {
    public static String getVideoFileLink(String VideoLink) throws JarException, IOException, JSONException {
        String query = URLEncoder.encode(String.valueOf(VideoLink), "utf-8");
        String url = "https://media-fire-api.herokuapp.com/?url=" + query;
        URL websiteurl = new URL(url);
        HttpsURLConnection myConnection = (HttpsURLConnection) websiteurl.openConnection();
